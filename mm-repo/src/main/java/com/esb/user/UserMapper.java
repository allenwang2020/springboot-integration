...
public interface UserMapper {
	...
	*//**
		 ...
		 *//*
			 ...
			 * ) User get(@Param("username") String username, @Param("password") String
			 * password);
			 * 
			 * @SelectProvider(type = UserSqlProvider.class, method = "getBadUser") User
			 * getBadUser(@Param("username") String username, @Param("password") String
			 * password);
			 */

	
	@Insert("INSERT INTO `sk_user` VALUES (#{userId},#{username},#{password},#{phoneNum})")
